...
RTE_OVERTHINKING_PROMPT_PARAMS = {
    i: {
        "labels": RTE_OVERTHINKING_LABELS[i],
        "prompt_format": RTE_OVERTHINKING_PROMPT_FORMATS[i],
        "prefix_narrative": RTE_OVERTHINKING_PREFIX_NARRATIVES[i],
    }
...
PROMPT_PARAMS = {
    ...
    "rte_overthinking_step": RTE_OVERTHINKING_PROMPT_PARAMS,
    "rte_overthinking_start": RTE_OVERTHINKING_PROMPT_PARAMS,
